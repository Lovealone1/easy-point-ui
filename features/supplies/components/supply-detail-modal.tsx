...
import type { Supply } from "../types/supplies.types"
import { UNIT_OF_MEASURE_LABELS } from "../types/supplies.types"
        ...
        <div className="space-y-4 sm:space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            <div className="flex items-center gap-3 rounded-lg border border-border/40 p-3 bg-card shadow-2xs">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-semibold text-foreground mt-0.5">
                  {UNIT_OF_MEASURE_LABELS[supply.unitOfMeasure] || supply.unitOfMeasure}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-lg border border-border/40 p-3 bg-card shadow-2xs">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-semibold text-foreground mt-0.5">
                  {formatCurrency(supply.basePrice)}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-lg border border-border/40 p-3 bg-card shadow-2xs">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-semibold text-foreground mt-0.5">
                  {formatCurrency(supply.pricePerUnit)}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-lg border border-border/40 p-3 bg-card shadow-2xs sm:col-span-2">
              ...
              <button
                onClick={() => handleCopy(supply.id, "ID")}
          ...
          <div className="flex flex-col gap-2 rounded-lg border border-border/40 p-3.5 bg-muted/10">
            ...
            <p className="text-xs text-foreground/90 italic leading-relaxed pl-6 border-l border-border/80">
              {supply.notes || "No hay notas ingresadas para este insumo."}
            </p>
          </div>
        </div>
