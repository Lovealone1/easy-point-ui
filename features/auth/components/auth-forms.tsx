        ...
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <form className="space-y-5" onSubmit={handleRegisterSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 px-4 rounded-lg bg-background border-border/70"
                  />
                </div>
              </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 mt-4 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground text-base font-semibold"
            >
              {isLoading ? (
                <><Loader2 className="w-4 h-4 animate-spin mr-2" /> Enviando código...</>
              ) : 'Crear cuenta'}
