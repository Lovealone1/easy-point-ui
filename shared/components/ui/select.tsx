  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Plain height classes, not `data-[size=…]:h-*`: an attribute-scoped
        // variant outranks a bare `h-11` from the call site both in specificity
        // and past tailwind-merge, so every trigger silently stayed at h-9 while
        // the inputs beside it grew. Written this way, callers can override.
        size === "sm" ? "h-8" : "h-9",
        className
      )}
      {...props}
