        ...
        {isPersonal ? (
          ...
          <div className="relative overflow-hidden p-3 rounded-xl border border-sidebar-border hover:border-brand-500/40 bg-card/40 hover:bg-brand-500/5 transition-all duration-300 space-y-2 group">
            ...
            <div className="relative flex items-center gap-2.5 min-w-0">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-brand-500/20 to-brand-500/5 border border-brand-500/20 text-sidebar-primary flex items-center justify-center font-bold text-[15px] shrink-0 select-none shadow-sm group-hover:scale-105 transition-transform duration-300">
                {initial}
              </div>
