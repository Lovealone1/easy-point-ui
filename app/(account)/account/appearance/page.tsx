// ─────────────────────────────────────────────────────────────────────────────
// app/(account)/account/appearance/page.tsx
//
// Colour and theme. Moved here from /personal/appearance, which now redirects:
// these live on UserPreferences, so they follow the person into every space
// they open — they were never a property of the personal space.
//
// Live preview behaviour is unchanged: the colour is applied to the DOM as you
// pick it and reverted from a snapshot if you discard, so "Descartar" really
// undoes what you were looking at.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function AccountAppearancePage() {
  ...
  return (
    <AccountPage
      title="Apariencia"
      description="El color y el tema con los que ves Easy Point. Te acompañan en todos tus espacios y se aplican al instante."
    >
      <AccountSection
        title="Color principal"
        description="Se usa en botones, enlaces y en el menú lateral."
      >
      ...
      <AccountSection title="Tema" description="El que se aplica cuando abres Easy Point.">
